  ...
  return (
    <section className="bg-gray-900 text-white py-16">
      <div className="container mx-auto px-6">
        ...
        <div className="w-16 h-1 bg-blue-600 mx-auto mb-12"></div> {/* Blue line */}

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {certifications.map((certification, index) => (
            <Zoom key={index} triggerOnce>
              <div
                className="bg-gray-800 p-6 rounded-lg shadow-lg transform hover:scale-105 hover:translate-y-2 transition-all duration-300 animate__animated animate__fadeInUp"
              >
